# ALSTECH — Olagoke Abdulqudus Portfolio

> **“JUST A LITTLE BOY TRYING TO BECOME A MAN.”**

Official personal portfolio of **Olagoke Abdulqudus** — Founder of **ALSTECH** & **Web3Central**, Frontend Engineer, Web3 Product Builder, Motion Designer, and Social Media Manager.

---

## 🌟 Overview

This repository contains the full source code and media assets for my official portfolio website. The application showcases my engineering capabilities spanning frontend web development, decentralized Web3 platforms, hardware diagnostics with microsoldering, digital marketing, and motion design.
...
- **Athletic Background**: Department Football Team Captain (Winner of 9 Medals and 2x MVP Player awards across 2 tournaments).
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Expat-Q/My-Portfolio.git
   cd My-Portfolio
   ```
...
- **Email**: [Olagokeabdulqudus5@gmail.com](mailto:Olagokeabdulqudus5@gmail.com)
- **WhatsApp**: [+234 704 478 7213](https://wa.me/2347044787213)
- **X (Twitter)**: [@expatq3](https://x.com/expatq3)
- **Instagram**: [@expatq3](https://instagram.com/expatq3)

---

&copy; 2026 Olagoke Abdulqudus • ALSTECH. All rights reserved.
